...
Isabela Rocha, from Brazil, mailto: [isabelarocha.contato@gmail.com](isabelarocha.contato@gmail.com) / Master and PhD candidate in Political Science from the Institute of Political Science of the University of Brasília (IPOL UnB). She is interested in the areas of Computational Social Sciences, Political Behavior, Sovereignty and Data, and Language Policy. Member of the research group Public Information and Elections (IPê), of the Laboratory for Research in Political Behavior, Institutions and Public Policies (LAPCIPP) and coordinator of the Working Group on Strategy, Data and Sovereignty of the Group for Studies and Research in International Security of the Institute of International Relations of the University of Brasília (GEPSI IREL). More info at: [https://www.rochaisabela.com/](https://www.rochaisabela.com/).
